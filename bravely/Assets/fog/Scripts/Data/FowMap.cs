...
namespace Fog
{
    ...
    public class FowMap
    {
        ...
        ***********************************************************************/
        ...
        public List<FowTile> TilesInSight { get; }
        ...
        public void ComputeFog(TilePos pos, in float sightXZ, in float sightY )
        {
            ...
            foreach(var unit in FM.UnitList)
            {
                bool result = false;

                foreach(var tile in visibleTileList)
                {
                    if(FM.GetTilePos(unit).x == tile.pos.x && 
                       FM.GetTilePos(unit).y == tile.pos.y)
                    {
                        result = true;
        ...
        ***********************************************************************/
        ...
        public List<FowTile> GetVisibleTilesInRange(List<FowTile> tilesInSight, in TilePos centerPos, in float sightHeight)
        {
            visibleTiles.Clear();
